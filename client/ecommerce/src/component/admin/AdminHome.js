                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                            <div className="au-card-title" style={{ backgroundImage: "url('assets/images/bg-title-01.jpg')" }}>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                            <div className="au-card-title" style={{ backgroundImage: "url('assets/images/bg-title-02.jpg')" }}>
                                                <div className="bg-overlay bg-overlay--blue"></div>
                                                <h3>
